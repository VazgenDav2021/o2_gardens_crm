...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Menu category grouping subcategories (e.g. "Hot Dishes", "Salads")';
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide settings: navbar, footer, and default SEO';
    displayName: 'Global';
    pluralName: 'globals';
    singularName: 'global';
  };
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Top-level menu (e.g. Main Menu, Bar, Combo). Each menu has its own categories \u2192 subcategories \u2192 products.';
    displayName: 'Menu';
    pluralName: 'menus';
    singularName: 'menu';
  };
  ...
  attributes: {
    ...
    menuKind: Schema.Attribute.Enumeration<
      ['main', 'bar', 'combo', 'breakfast', 'lunch', 'delivery', 'other']
    > &
      Schema.Attribute.Required &
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Composable page built from layout blocks';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A single menu item / dish';
    displayName: 'Product';
    pluralName: 'products';
...
export interface ApiSubCategorySubCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Sub-category grouping products (e.g. "Grilled", "Fried")';
